...
public class newsLatestFragment extends Fragment {
    ...
    private RecyclerView recyclerViewoflatest;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_news_latestnews,null);

        recyclerViewoflatest = v.findViewById(R.id.recyclerviewoflatestnews);
        newsModelClassArrayList = new ArrayList<>();
        recyclerViewoflatest.setLayoutManager(new LinearLayoutManager(getContext()));
        newsAdapter = new newsAdapter(getContext(), newsModelClassArrayList);
        recyclerViewoflatest.setAdapter(newsAdapter);
